...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-6 py-3 rounded-xl hover:shadow-2xl transition transform hover:scale-105 font-semibold">
                Mulai Gratis
              </button> */}
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-lg border-t shadow-xl">
            <div className="px-4 pt-4 pb-6 space-y-3">
              <a href="#home" className="block py-3 text-gray-700 hover:text-blue-600 font-medium">Beranda</a>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-purple-200 shadow-sm">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="h-40 bg-gradient-to-t from-blue-50 to-purple-50 rounded-2xl flex items-end justify-around p-4">
                      {[40, 60, 45, 75, 55, 85, 70, 95].map((height, i) => (
                        <div key={i} className="w-8 bg-gradient-to-t from-blue-600 to-purple-600 rounded-t-lg transition-all hover:scale-110" style={{height: `${height}%`}}></div>
                      ))}
                    </div>
      ...
      {/* Services Section */}
      <section id="services" className="py-24 px-4 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {services.map((service, idx) => (
              <div key={idx} className={`relative ${service.popular ? 'lg:-mt-4 lg:mb-4' : ''}`}>
                {service.popular && (
